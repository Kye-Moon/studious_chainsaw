...
from src.models.ProductHuntPostResponse import ProductHuntPostResponse
from src.models.ProductHuntCommentMessage import ProductHuntMention
...
def process_ph_post_integration_record(url: str, campaign_id: str, db: DynamoDB):
    ...
    if request.status_code == 200:
        ...
        for mention in filteredMentions:
            try:
                print(mention.dict(exclude={"PK", "SK"}))
